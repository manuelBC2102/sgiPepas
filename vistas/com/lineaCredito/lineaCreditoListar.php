    ...
    <body >
        ...
        <div class="row" id="p_desc">
            ...
            <div class="panel panel-default">
                <a href="#" style="border-radius: 0px;" class="btn btn-info w-md" onclick="nuevaLineaCredito();"><i class=" fa fa-plus-square-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nuevo</a>
                <br><br>
        ...
        <script src="vistas/com/lineaCredito/lineaCreditoListar.js"></script>
