                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <!--<button id="btnBuscar" type="button" data-toggle="collapse" data-parent="#accordion1" href="#bg-info" onclick="buscarBalanceConsolidadoGeneral()" value="enviar" class="btn btn-purple"><i></i>&ensp;Buscar</button>&nbsp;&nbsp;-->
                                        <button type="button" href="#bg-info" onclick="buscarBalanceConsolidadoGeneral(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                ...
                <div class="panel panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <!--<div class="table-responsive">-->
                            <div id="dataList">
                                <table id="datatableBalanceConsolidado" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style='text-align:center;'>Imp. pend.</th>
...
<!--                                    <tfoot>
        ...
        <script src="vistas/com/reporte/reporteBalanceConsolidadoGeneral.js"></script>
    </body>
</html>
