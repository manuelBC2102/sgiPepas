            ...
            <div class="panel panel-default">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <div class="form-group col-md-12">
                                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <select name="cboSegun" id="cboSegun" class="select2">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteConsolidadoCotizacion();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>
                                        <button type="button" href="#bg-info" onclick="buscarReporteConsolidadoCotizacion(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div id="dataList">
                            <table id="datatableReporteConsolidadoCotizacion" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style='text-align:center;'>Costo Directo</th>
...
<div id="modalDetalleDocumento"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-full"> 
        ...
        <script src="vistas/com/reporte/reporteConsolidadoCotizaciones.js"></script>
    </body>
</html>