                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            <a onclick="exportarReporteReporteOrdenCompra()" title="">
                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteReporteOrdenCompra();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>&nbsp;&nbsp;  
                                        <button type="button" href="#bg-info" onclick="buscarReporteOrdenCompra(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <!--<div class="table-responsive">-->
                            <div id="dataList">
                                <table id="dataTableReporteOrdenCompra" class="table table-striped table-bordered">
                                    <thead>

<!--F. Creacion	F. Emisión	Tipo documento	Persona	Serie	Número-->                                        
                                        <tr>
                                            <th style='text-align:center;'>F. Tentativa</th>
...
<!--                                    <tfoot>
        ...
        <!--</div>-->
        <script src="vistas/com/reporte/reporteOrdenCompra.js"></script>
    </body>
</html>
