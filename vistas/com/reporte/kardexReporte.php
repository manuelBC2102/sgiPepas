<html lang="es">
    ...
    <body >
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            ...
                                            <a onclick="exportarKardexReporteExcel()" title="">
                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarKardexReporteExcel();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;"></i>&ensp;Exportar reporte</button>&nbsp;&nbsp;  
                                        <!--<button type="button" data-toggle="collapse" data-parent="#accordion1" href="#bg-info" onclick="buscarKardexReporte()" value="enviar" class="btn btn-purple"><i></i>&ensp;Buscar</button>&nbsp;&nbsp;-->
                                        <button type="button" href="#bg-info" onclick="buscarKardexReporte(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style='text-align:center;'>Cód. Cont.</th>
        ...
        <script src="vistas/com/reporte/kardexReporte.js"></script>
    </body>
</html>
