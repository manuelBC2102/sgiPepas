...
<!--                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
            ...
            <div id="modal_detalle_pagos_general"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:80%;"> 
                    <div class="modal-content"> 
                        ...
                        <div class="modal-body"> 
                            <div class="table">
                                <div id="dataList">
                                    <table id="datatableDetallePagoGeneral" class="table table-striped table-bordered" >
                                        <thead>
                                            <tr>
...
<!--                                        <tfoot>
        ...
        <!--</div>-->
        <script src="vistas/com/reporte/reporteCuentasPorPagarGeneral.js"></script>
    </body>
</html>
