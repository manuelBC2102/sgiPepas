<html lang="es">
    ...
    <body >
                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <!--<button id="btnBuscar" type="button" data-toggle="collapse" data-parent="#accordion1" href="#bg-info" onclick="buscarBalance()" value="enviar" class="btn btn-purple"><i></i>&ensp;Buscar</button>&nbsp;&nbsp;-->
                                        <button type="button" href="#bg-info" onclick="buscarBalance(1)" value="enviar" class="btn btn-purple"> Buscar</button>
        ...
        <script src="vistas/com/reporte/reporteBalance.js"></script>
    </body>
</html>
