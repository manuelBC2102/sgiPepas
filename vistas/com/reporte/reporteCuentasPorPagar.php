...
<!--                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteCXP();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>
                            ...
                            <table id="dataTableDeuda" class="table table-striped table-bordered" widht="300px">
                                <thead>
                                    <tr>
                                        ...
                                        <th style='text-align:center; vertical-align: middle;' rowspan="2">S/N Documento</th>
