<html lang="es">
    ...
    <body >
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            ...
                                            <!--<a onclick="exportarReporteDispersionBienesExcel()" title="">
                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        <!--<button type="button" onclick="exportarReporteDispersionBienesExcel();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>&nbsp;&nbsp;  -->
                                        <button type="button" href="#bg-info" onclick="buscarDispersionBienes(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="portlet"><!-- /primary heading -->
                                ...
                                <div id="portlet4" class="panel-collapse collapse in">
                                    <div class="portlet-body">
                                        <div id="graficoDispersionBienes" style="height: 300px;"></div>
                                    </div>
                                </div>
                            </div> <!-- /Portlet -->
                        </div>
            ...
            <div class="modal-dialog modal-full"> 
                <div class="modal-content"> 
                    ...
                    <div class="modal-body"> 
                        <div class="table">
                            <div id="dataList">
                                <table id="datatableDispersionBienes" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>                                            
                                            <th style='text-align:center;'>Bien</th>
        ...
        <script src="vistas/com/reporte/dispersionBienes.js"></script>
