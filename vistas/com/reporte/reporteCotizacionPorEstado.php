            ...
            <div class="panel panel-default">
                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                            ...
                                            <div class="form-group col-md-12">
                                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <select name="cboEstado" id="cboEstado" class="select2">
                                                        <option selected value="-1">Seleccionar un estado</option>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteCotizacion();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>
                                        <button type="button" href="#bg-info" onclick="buscarReporteCotizacion(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div id="dataList">
                            <table id="datatableReporteCotizacion" class="table table-striped table-bordered">
                                <thead>
                                    <tr>                                            
...
<div id="modalDetalleDocumento"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-full"> 
        ...
        <script src="vistas/com/reporte/reporteCotizacionPorEstado.js"></script>
    </body>
</html>