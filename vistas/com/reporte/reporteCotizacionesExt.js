$(document).ready(function () {
    cargarTitulo("titulo", "");
    ax.setSuccess("onResponseReporteCotizacionesExt");
//    obtenerConfiguracionesInicialesCotizacionessAtendidos();
//    modificarAnchoTabla('datatable');
    buscarCotizaciones();
});

function onResponseReporteCotizacionesExt(response) {
...
//                loaderClose();
                break;
            case 'obtenerDataCotizacionesExt':
                onResponseObtenerDataCotizaciones(response.data);
                loaderClose();
                break;
            case 'obtenerCotizacionesDetalleExt':
...
{
    ax.setAccion("obtenerDataCotizacionesExt");
    ...
    if (!isEmptyData(data)){
        $('#datatable').dataTable({          
            ...
            "columns": [
                ...
                {"data": "bien_codigo", width: "15%"},
                {"data": "bien_descripcion",  "sClass": "alignLeft", width: "30%"},
                {"data": "proveedor_descripcion",  "sClass": "alignLeft", width: "30%"},
                {"data": "bien_id", "sClass": "alignCenter", width: "10%"}
            ],
            columnDefs: [
                {
...
{
    loaderShow();
    ax.setAccion("obtenerCotizacionesDetalleExt");
