<div class="page-title">
    <h3 class="title">Pago a proveedores</h3>
</div>
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-10">                    
                <div class="form-group input-group" id="divBuscador">
                    ...
                    <input type="text" id="txtBuscar" name="txtBuscar" data-toggle="dropdown" class="dropdown-toggle form-control" placeholder="Buscar" onkeyup="buscarCriteriosBusquedaDocumentoPagadosListarPago()">                                
...
<script src="vistas/com/pago/pago_documentos_pagados.js"></script>