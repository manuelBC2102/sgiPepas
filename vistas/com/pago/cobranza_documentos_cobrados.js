...
//                }
            ...
            case 'obtenerDetallePago':
                ...
                loaderClose();
                break;
            case 'buscarCriteriosBusquedaDocumentoPagadosListar':
                onResponseBuscarCriteriosBusquedaDocumentoPagadosListar(response.data);
                loaderClose();
                break;
...
function getPagoDataTable() {
    ax.setAccion("obtenerDocumentosCobrados");
    ax.addParamTmp("empresa_id", commonVars.empresa);
    ...
    $('#datatableListaPagos').dataTable({
        ...
        "columns": [
            ...
            {"data": "persona_nombre_completo", "width": "200px"},
            {"data": "serie", "width": "50px"},
            {"data": "numero", "width": "60px"},
            {"data": "fecha_vencimiento", "class": "alignCenter", "width": "60px"},
            {"data": "moneda_descripcion", "width": "50px"},
            {"data": "pendiente", "class": "alignRight", "width": "40px"},
...
function buscarCriteriosBusquedaDocumentoPagadosListar(){    
//    loaderShow();
    //buscarDocumentoPago();
    ax.setAccion("buscarCriteriosBusquedaDocumentoPagadosListar");
    ax.addParamTmp("busqueda", $('#txtBuscar').val());
    ax.addParamTmp("empresa_id", commonVars.empresa);
    ax.consumir();
}

function onResponseBuscarCriteriosBusquedaDocumentoPagadosListar(response){
