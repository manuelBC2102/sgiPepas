    ...
    <body >
        ...
        <div class="row" id="p_desc">
            ...
            <div class="panel panel-default">
                <a href="#" style="border-radius: 0px;" class="btn btn-info w-md" onclick="nuevoDocumentoTipoDatoLista();"><i class=" fa fa-plus-square-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nuevo</a>
                <br><br>
                <div class="panel panel-body" id="muestrascroll">
                    <div class="col-md-12 col-sm-12 col-xs-12" id="scroll">
                        <div id="datatableListar">
        ...
        <script src="vistas/com/documento/documentoTipoDatoListaListar.js"></script>
        <script type="text/javascript">
                    $(document).ready(function () {
                        loaderShow(null);
                        listarDocumentoTipoDatoLista();
                        altura();
                    });
