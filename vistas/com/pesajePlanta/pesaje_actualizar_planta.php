<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="loteForm">
                        ...
                        <!-- <div class="col-md-4">
                            <label for="ticket2">Ticket Regulador</label>
                            <input type="text" class="form-control" id="ticket2" name="ticket2">
                        </div> -->
    ...
    <script src="vistas/com/pesajePlanta/pesaje_actualizar_planta.js"></script>
