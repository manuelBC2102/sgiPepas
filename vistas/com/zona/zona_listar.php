    ...
    <body >
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                <a href="#" style="border-radius: 0px;" class="btn btn-info w-md" onclick="cargarDivIndex('#window', 'vistas/com/zona/zona_form.php',354,'')"><i class=" fa fa-plus-square-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nuevo</a>
                <br><br>
        ...
        <script src="vistas/com/zona/zona_listar.js"></script> 
    </body>
</html>
