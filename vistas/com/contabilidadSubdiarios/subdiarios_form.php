<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo $_GET['winTitulo']; ?> Subdiario</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="row">    
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">                                
                        <select name="cboTipoAsientos" id="cboTipoAsientos" class="select2">
                        </select>
                        <span id='msjTipoAsientos' class="control-label" style='color:red;font-style: normal;' hidden></span>
                    </div>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="row" id="rowNumeracion"> 
                ...
                <div class="col-md-4">                        
                    <table class="table table-striped table-bordered" style="text-align: center;">
                        <tbody id="tbodySubdiarioNumeracion" >
...
<script src="vistas/com/contabilidadSubdiarios/subdiarios_form.js"></script>