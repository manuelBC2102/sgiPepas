<div class="page-title">
    <h3 id="titulo" class="title">Registro Invitación</h3>
</div>
...
<div class="modal fade" id="linkModal" tabindex="-1" role="dialog" aria-labelledby="linkModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <button class="btn btn-info" onclick="copiarHTML()">Copiar HTML</button>
...
<script src="vistas/com/invitacion/invitacion_listar.js"></script>