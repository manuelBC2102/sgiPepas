    ...
    <div class="col-lg-12">
                    ...
                    <div id="bg-info" class="panel-collapse collapse in">
                        <div class="portlet-body">
                                ...
                                <!-- <div class="form-group col-md-6">
                                                    <label>Factura</label>
                                                        <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <input type="text" id="txtFactura" name="txtFactura" class="form-control" value="" maxlength="500"/>
                                                        </div>
                                                    </div>   -->
                            ...
                            <button type="button" onclick="limpiarBuscadores()" value="enviar" class="btn btn-green">Limpiar filtros</button>
                                ...
                                <button type="button" onclick="exportarReporteExcel()" value="enviar" class="btn btn-purple">Exportar</button>
        ...
        <div class="row">
            <table id="datatable" class="table table-striped table-bordered" >
                <thead>
                    <tr>
                        <th style='text-align:center;'>Fecha Retención</th>
                        <th style='text-align:center;'>Emisor</th>
                        <!-- <th style='text-align:center;'>Zona</th> -->
                        <th style='text-align:center;'>Número Retención</th>
                        <th style='text-align:center;'>Monto Retención</th>
                        <th style='text-align:center;'>Porcentaje Retención</th>
                        <th style='text-align:center;'>Proveedor</th>
                        <th style='text-align:center;'>Factura</th>
                        <th style='text-align:center;'>Monto Factura</th>
                        <th style='text-align:center;'>Fecha Factura</th>
                        <th style='text-align:center;'>Moneda Factura</th>
        ...
        <div style="clear:left">
            <p><b>Leyenda:</b>&nbsp;&nbsp;
                ...
                <i class="fa fa-file-archive-o" style="color:#cb2a2a;"></i> PDF Retención&nbsp;&nbsp;&nbsp;
                <i class="fa fa-file-archive-o" style="color:green;"></i> XML Retención&nbsp;&nbsp;&nbsp;
                <i class="fa fa-file-archive-o" style="color:blue;"></i> CDR Retención&nbsp;&nbsp;&nbsp;
...
<script src="vistas/com/retenciones/retenciones.js"></script>