...
function onResponseAjaxpGetDataGridZona(data) {
    ...
    var cabeza = '<table id="datatable" class="table table-striped table-bordered"><thead>' +
        ...
        "<th style='text-align:center;'>Nombre derecho</th>" +
        ...
        if (!isEmpty(data)) {
            ...
            $.each(data, function (index, item) {
                  ...
                  cuerpo = "<tr>" +
                    ...
                    "<td style='text-align:start;'>" + item.sector + "</td>" +
                    ...
                    "<a  href='envio_notificacion2.php?token="+item.token+"'><b><i class='fa fa-file-pdf-o' style='color:#0366b0;'></i><b></a>\n" +
