...
{   
    ...
    cargarDiv('#window', 'vistas/com/invitacion/invitacion_principal_form.php', "Nueva ");
}
...
//    var clasePersona = $("#cboClasePersonaBusqueda").val();
    ax.setAccion("getDataGridInvitacionPrincipal");
     if(id==null){
...
function editarInvitacion(id) {
    ...
    cargarDiv("#window", "vistas/com/invitacion/invitacion_principal_form.php", "Editar Invitación ");
}
