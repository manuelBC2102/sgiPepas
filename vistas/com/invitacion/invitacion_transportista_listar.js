...
{    commonVars.personaId = 0;
    cargarDiv('#window', 'vistas/com/invitacion/invitacion_transportista_form.php', "Nueva ");
}
...
//    var clasePersona = $("#cboClasePersonaBusqueda").val();
    ax.setAccion("getDataGridInvitacionTransportista");
     if(id==null){
                ...
                render: function (data, type, row) {
                    if (type === 'display') {
                        ...
                        return '<a onclick="editarInvitacion(' + row.id + ')"><b><i class="fa fa-edit" style="color:#088a08;"></i><b></a>\n\
                                   ...
                                   <a target="_blank" href="envio_notificacion3.php?token='+row.token+'"><b><i class="fa fa-file-pdf-o" style="color:#0366b0;"></i><b></a>\n\
...
function openModal(id,token) {
    ...
    var archivo = "/sgiLaVictoria/envio_notificacion3.php"; // Cambia esto por el nombre del archivo que necesites
    ...
    if (response['status'] === 'ok') {
        switch (response[PARAM_ACCION_NAME]) {
            ...
            case 'cambiarEstadoPersona':
                ...
                listarPersona();
                break;
            case 'deleteSolicitudTransportista':
                loaderClose();
...
{    
    loaderShow();
    ax.setAccion("deleteSolicitudTransportista");
    ax.addParamTmp("id", id);
    ax.consumir();
}
