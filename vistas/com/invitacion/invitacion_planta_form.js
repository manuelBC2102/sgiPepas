...
$(document).ready(function () {
    ...
    ax.setAccion("obtenerConfiguracionesInvitacionPlanta");
    ...
    if (response['status'] === 'ok') {
        switch (response[PARAM_ACCION_NAME]) {
            case 'obtenerPersona':
                ...
                break;
            case 'obtenerConfiguracionesInvitacionPlanta':
            ...
            case 'insertSolicitud':
                ...
                break;
            case 'guardarInvitacionPlanta':
                debugger;
                mostrarOk("Invitación registrada");
                loaderClose();
                cargarListarPersonaCancelar();
                break;
            case 'actualizarInvitacionPlanta':
                debugger;
...
{
    loaderShow(null);
    cargarDiv('#window', 'vistas/com/invitacion/invitacion_planta_listar.php');
}
...
debugger;
    ...
    $('#txtDireccion').val(data.invitacion[0].direccion).prop('readonly', true);
    ...
    $('#txtCodigo').val(data.invitacion[0].fecha_inscripcion).prop('readonly', true);
...
{
    loaderShow(null);
    cargarDiv('#window', 'vistas/com/invitacion/invitacion_planta_listar.php', 'Registro invitación');
}
...
function guardarSolicitud() {
    ...
    loaderShow();
    if(invitacionId>0){
        ax.setAccion("actualizarInvitacionPlanta");
    ...
    ax.setAccion("guardarInvitacionPlanta");
    ax.addParamTmp("ruc", ruc);
    ax.addParamTmp("fecha", fecha);
    ax.addParamTmp("nombre", nombre);
    ax.addParamTmp("direccion", direccion);
