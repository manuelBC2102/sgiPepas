...
function listarInvitaciones() {
    debugger;
    ax.setAccion("listarInvitacionPlanta");
    ax.consumir();
}
        ...
        if (!isEmpty(data)) {
            ...
            $.each(data, function (index, item) {
                  ...
                  cuerpo = "<tr>" +
                    ...
                    "<a  href='envio_notificacion6.php?token="+item.token+"'><b><i class='fa fa-file-pdf-o' style='color:#0366b0;'></i><b></a>\n" +
