...
var valoresBusquedaPorCuenta = [{documentoTipo: "",  mes: "",anio: "",cuenta:""}];
...
function cargarDatosBusqueda()
{
    ...
    valoresBusquedaPorCuenta[0].documentoTipo = documentoTipo;
    valoresBusquedaPorCuenta[0].cuenta = cuenta;
    valoresBusquedaPorCuenta[0].mes = mes;
    valoresBusquedaPorCuenta[0].anio = anio;
    valoresBusquedaPorCuenta[0].empresaId = commonVars.empresa;
}
...
function obtenerDatosBusqueda()
{
    ...
    if (!isEmpty(valoresBusquedaPorCuenta[0].mes))
    {
        cadena += negrita("Mes: ");
    ...
    if (!isEmpty(valoresBusquedaPorCuenta[0].anio))
    {
        cadena += negrita("Anio: ");
    ...
    if (!isEmpty(valoresBusquedaPorCuenta[0].documentoTipo))
    {
    ...
    if (!isEmpty(valoresBusquedaPorCuenta[0].cuenta))
    {
