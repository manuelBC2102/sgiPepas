                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            ...
                                            <a onclick="exportarReportePorCuentaExcel()" title="">
...
<!--                                        <div class="form-group col-md-6 ">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReportePorCuentaExcel();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>&nbsp;&nbsp;  
                                        ...
                                        <button type="button" href="#bg-info" onclick="buscarPorCuenta(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th style='text-align:center; vertical-align: middle;' colspan="3">Retención</th>
                                </tr>
                                <tr>
...
<!--                <div style="clear:left">
        ...
        <script src="vistas/com/reporteCajaBancos/porCuentaGeneral.js"></script>
    </body>
</html>
