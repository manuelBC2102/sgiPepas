...
function listarDocumentoTipo(){
    ax.setAccion("listarDocumentoTipo");  
...
function exitoDocumentoTipo(response) {
    if (response.status === 'ok') {
        switch (response[PARAM_ACCION_NAME]) {
            case 'listarDocumentoTipo':
                onResponseListarDocumentoTipo(response.data);
                onResponseVacio();
                loaderClose();
                break;
            case 'cambiarEstado':
...
function nuevo() {
    var titulo = "Nueva";
    var url = URL_BASE + "vistas/com/contabilidadDocumentoTipo/documento_tipo_form.php?winTitulo=" + titulo;
    cargarDiv("#window", url);
}

function onResponseListarDocumentoTipo(data) {
    $("#dataList").empty();
    var cuerpo_total = "";
    var cuerpo = "";
    var cuerpo_acc = "";    
...
//            + "<th style='text-align:center; vertical-align: middle;'>Código</th>"
            ...
            + "<th style='text-align:center; vertical-align: middle;'>Tipo comprobante Sunat</th>"
...
function editar(id) {
    var titulo = "Editar";
    var url = URL_BASE + "vistas/com/contabilidadDocumentoTipo/documento_tipo_form.php?winTitulo=" + titulo + "&id=" + id;
    cargarDiv("#window", url);
}
...
function confirmarEliminar(id, nom) {
    ...
    swal({
        title: "Estás seguro?",
        text: "Eliminarás el tipo de documento: " + nom + "!",
        type: "warning",
