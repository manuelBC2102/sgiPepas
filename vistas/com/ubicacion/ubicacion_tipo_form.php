...
if ($tipo == 1)
    $titulo = "Editar tipo de ubicación";
else
    $titulo = "Nuevo tipo de ubicación";
?>

<!DOCTYPE html>
<html lang="es">
    <head>
        <title>Mantenimietno de Tipo de Bienes</title>
...
<!--        <section class="content">-->
            ...
            <div class="col-md-12 ">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-12 ">
                            <div class="panel-body">
                                <form  id="frm_ubicacion_tipo"  method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <a href="#" class="btn btn-danger m-b-5" id="id" style="border-radius: 0px;" onclick="cargarDiv('#window', 'vistas/com/ubicacion/ubicacion_tipo_listar.php')" ><i class="fa fa-close"></i>&ensp;Cancelar</a>&nbsp;&nbsp;&nbsp;
                                            <button type="button" onclick="guardarUbicacionTipo('<?php echo $tipo; ?>')" value="enviar" name="env" id="env" class="btn btn-info w-sm m-b-5" style="border-radius: 0px;"><i class="fa fa-send-o"></i>&ensp;Enviar</button>&nbsp;&nbsp;
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <script src="vistas/com/ubicacion/ubicacion_tipo.js"></script>
    </body>
