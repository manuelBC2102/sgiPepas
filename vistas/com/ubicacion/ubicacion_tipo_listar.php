<html lang="es">
    <head>
        ...
        <title>Tipo de ubicaci&oacute;n</title>
    </head>
    <body >
        <div class="page-title">
            <h3 class="title">Tipo de ubicaci&oacute;n</h3>
        </div>
        <div class="row">
            <div class="panel panel-default">
                <a href="#" style="border-radius: 0px;" class="btn btn-info w-md" onclick="cargarDiv('#window', 'vistas/com/ubicacion/ubicacion_tipo_form.php')"><i class=" fa fa-plus-square-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nuevo</a>
                <br><br>
