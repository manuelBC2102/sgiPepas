                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="txtPlacaV" readonly name="txtPlacaV" class="form-control" aria-required="true" value="" maxlength="250" />
                                    </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="txtFechaInicial" readonly name="txtFechaInicial" class="form-control" aria-required="true" value="" maxlength="250" />
                                    </div>
                                    <span id='msjFechaEntrega' class="control-label" style='color:red;font-style: normal;' hidden></span>
                                </div>
                                <!-- <div class="form-group col-md-3">
...
<div class="form-group col-md-3">
    ...
    <div id="pesajeContainer" >
        <div id="pesajeContainerContent">
            ...
            <label>Pesaje final (vehículo con carga)</label>
            <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <input type="text" id="txtPesajeFinal" name="txtPesajeFinal" class="form-control" aria-required="true" value="" maxlength="250" disabled />
                <div class="input-group-append">
                    <button type="button" class="btn btn-primary" onclick="traerPesaje('final')">
                        <i class="fa fa-search"></i> Obtener pesaje final
                    </button>
                </div>
            </div>
            <div id="fechaPesajeFinal" class="fecha-pesaje"></div> <!-- Fecha y hora pesaje final -->
        </div>
    </div>
</div>
...
<style>
    ...
    <script src="vistas/com/actaRetiro/acta_retiro_form.js"></script>
</body>
