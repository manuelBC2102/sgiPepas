...
<div class="form-group col-md-3">
    ...
    <br>
    <label>¿Tiene balanza?</label>
    <div>
        <label>
            <input type="radio" name="balanza" value="si" onclick="togglePesaje(true)"> Sí
        </label>
        <label>
            <input type="radio" name="balanza" value="no" checked onclick="togglePesaje(false)"> No
        </label>
    </div>

    <!-- Contenedor para los pesajes inicial y final -->
    <div id="pesajeContainer" style="display: none;">
