            ...
            <ul class="nav nav-tabs nav-justified">
                ...
                <li class="">
                    <a href="#tabProgramacionPagoDetalle" data-toggle="tab" aria-expanded="false" onclick="actualizarTabActivo(2)">
                        ...
                        <span class="hidden-xs">Detalle de programaciones de pago</span>
                    </a>
                </li>
            </ul>
                ...
                <div class="tab-pane active" id="tabDocumentos">
                                    ...
                                    <div class="input-group" id="divBuscador">                                
                                        <span class="input-group-btn" id="spanBuscador">
                                            ...
                                            <ul class="dropdown-menu extended fadeInUp animated nicescroll" tabindex="5001" style="overflow: hidden; outline: none;width: 1052px;" id="ulBuscadorDesplegable">
                                                ...
                                                <li>
                                                    <div class="form-group col-md-2">
                                                        <label style="color: #141719;">Serie(Cod./Número)</label>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="form-group col-md-2">
                                                        <label  style="color: #141719;">Fecha indicador</label>
                                                    </div>
                                                    <div class="form-group col-md-10">
                                                        <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="inicioFechaBL">
                                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="finFechaBL">
                                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3 col-sm-3">
                            <div class="input-group m-t-10">
                                <!--                <button class="btn btn-info btn-block" onclick="nuevoProgramacionPago()" >
                        ...
                        <div class="col-lg-10 col-md-9 col-sm-9" style="padding-top: 20px">
                            ...
                            <div style="clear:left">
                                <p id="divLeyenda">
                                    <br>
                                    <b>Leyenda:</b>&nbsp;&nbsp;
                                    <i class='fa fa-calendar-o' style='color:green;'></i> Registrar programación de pago &nbsp;&nbsp;&nbsp;
                                </p>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="form-group col-md-10">
                                                        <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="inicioFechaBL2">
                                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="finFechaBL2">
                                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    <div style="padding-top: 20px">
                        ...
                        <div style="clear:left">
                            <p id="divLeyendaPP">
                                <br>
                                <b>Leyenda:</b>&nbsp;&nbsp;
                                <i class='fa fa-calendar-o' style='color:green;'></i> Editar programación de pago &nbsp;&nbsp;&nbsp;
                                <i class='fa fa-lock' style='color:red;'></i> Por liberar &nbsp;&nbsp;&nbsp;
                                <i class='fa fa-unlock' style='color:green;'></i> Liberado &nbsp;&nbsp;&nbsp;
                                <i class='fa fa-money' style='color:green;' ></i> Pagado totalmente&nbsp;&nbsp;&nbsp;
                                <i class='fa fa-money' style='color:orange;' ></i> Pagado parcialmente &nbsp;&nbsp;&nbsp;
...
<script src="vistas/com/programacionPago/programacion_pago_listar.js"></script>