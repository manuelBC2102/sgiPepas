...
<div class="page-title">
    <h3 id="titulo" class="title"><?php echo $_GET['winTitulo']; ?> aprobación parcial</h3>
</div>
<!--<div class="row">-->
    ...
    <div class="modal-dialog">            
        <div class="modal-content">               
            <div class="modal-header">                      
                ...
                <h4 class="modal-title" id="tituloModalDetalle"><b>Detalle de aprobación parcial</b></h4>         
            </div>                     
...
<script src="vistas/com/programacionPago/aprobacion_parcial_form.js"></script>