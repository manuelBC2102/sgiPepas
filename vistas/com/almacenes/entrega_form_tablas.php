...
<html lang="es">    
    ...
    <body> 
                    ...
                    <div class="portlet-heading">               
                        <div class="row">                    
                            <div class="col-md-10" style="margin-top: -12px; margin-left: -32px;">  
                                ...
                                <div class="col-md-4">
                                    <div class="col-lg-2 col-md-4 col-sm-2 col-xs-6" id="contenedorMoneda">  
                                        <h4>                                   
                                    ...
                                    <div id="divContenedorOrganizador" class="col-lg-8 col-md-8 col-sm-6 col-xs-6" hidden="true">      
                                        <h4>                                   
        ...
        <script src="vistas/com/almacenes/entrega_form_tablas.js"></script>
    </body>
</html>