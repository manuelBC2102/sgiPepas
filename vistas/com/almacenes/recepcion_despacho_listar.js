            ...
            swal(
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        generarRecepcionDespacho([distribucionArray, dataFilasSeleccionadas], unicos[0]);
                    } else {
                        loaderClose();
                    }
                }
...
function onResponseObtenerPaqueteDetalleXPaqueteId(data, idx) {
    ...
    if (!isEmpty(data)) {
        ...
        cuerpo += "<td align='center' style='align-content: center;'>" + data.paquete_id + "</td>";
...
function generarRecepcionDespacho(distribucionArray, documentoId) {
