...
foreach ($documentoDatoValor as $index => $item) {
    switch ($item['tipo'] * 1) {
        case 5:
            $responsable = Persona::create()->obtenerPersonaXId($item['valor']);
            break;
        case 53:
...
$pdf->SetXY(115, 38);
$pdf->Cell(30, 5, utf8_decode('No. Sol. de entrega'), 0, 0, 'C');
...
$pdf->SetXY(10, 45);
$pdf->Cell(30, 5, utf8_decode('Almacén :'), 0, 0, 'L');
$pdf->SetXY(10, 52);
$pdf->Cell(30, 5, utf8_decode('Responsable :'), 0, 0, 'L');
// $pdf->SetXY(10, 59);
...
$pdf->SetXY(40, 52);
$pdf->Cell(30, 5, utf8_decode($responsable[0]['codigo_identificacion'] ." | ".$responsable[0]['nombre']), 0, 0, 'L');
// $pdf->SetXY(40, 59);
...
$pdf->MultiCell(39, 5, 'Solicitado por.', 0, 'C', true);
$pdf->SetFont('Arial', '', 8);
