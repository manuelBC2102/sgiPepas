<html lang="es">
    ...
    <body >
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            ...
                                            <a onclick="exportarReporteProductosMasVendidosExcel()" title="">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">                                        
                                        ...
                                        <div class="form-group col-md-2 ">
                                            <label>Top</label>
                                            <input type="number" id="txtLimite" name="txtLimite" class="form-control" required="" aria-required="true" value="10">
                                        </div>
                                    </div>

                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteProductosMasVendidosExcel();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>&nbsp;&nbsp;  
                                        <!--<button type="button" data-toggle="collapse" data-parent="#accordion1" href="#bg-info" onclick="buscarProductosMasVendidos()" value="enviar" class="btn btn-purple"><i></i>&ensp;Buscar</button>&nbsp;&nbsp;-->
                                        <button type="button" href="#bg-info" onclick="buscarProductosMasVendidos(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style='text-align:center; vertical-align: middle;' colspan="2">Número de ventas</th>
            ...
            <div class="modal-dialog modal-full"> 
                <div class="modal-content"> 
                    ...
                    <div class="modal-body"> 
                        <!--<div class="table">-->
                            <div id="dataList">
                                <table id="datatableDocumentoProductosMasVendidos" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>                                            
        ...
        <script src="vistas/com/reporteVentas/productosMasVendidos.js"></script>
    </body>
</html>
