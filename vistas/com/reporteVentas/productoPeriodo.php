<html lang="es">
    ...
    <body >
        <div class="page-title">
            ...
            <h3 class="title">Reporte de ventas de productos por periodo</h3>
        </div>
        <div class="row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            ...
                                            <a onclick="exportarReporteProductoPorPeriodoExcel()" title="">
                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteProductoPorPeriodoExcel();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>&nbsp;&nbsp;  
                                        <!--<button type="button" data-toggle="collapse" data-parent="#accordion1" href="#bg-info" onclick="buscarProductoPorPeriodo()" value="enviar" class="btn btn-purple"><i></i>&ensp;Buscar</button>&nbsp;&nbsp;-->
                                        <button type="button" href="#bg-info" onclick="buscarProductoPorPeriodo(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style='text-align:center;'>Imp. vendido S/.</th> 
                                    <th style='text-align:center;'>Imp. vendido $</th> 
                                </tr>
                            </thead>
                            <tfoot>
                                <tr>
...
<!--                <div style="clear:left">
            ...
            <div class="modal-dialog modal-full"> 
                <div class="modal-content"> 
                    ...
                    <div class="modal-body"> 
                        <div class="table">
                            <div id="dataList">
                                <table id="datatableDocumentoProductoPorPeriodo" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>                                            
        ...
        <script src="vistas/com/reporteVentas/productoPeriodo.js"></script>
    </body>
</html>
