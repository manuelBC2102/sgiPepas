                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="portlet-heading bg-purple m-b-0" 
                                        ...
                                        <div class="portlet-widgets">
                                            ...
                                            <a onclick="exportarReporteComisionVendedorExcel()" title="">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">     
                                        ...
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <select name="cboPersonaVendedor" id="cboPersonaVendedor" class="select2" multiple>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2 ">
                                            ...
                                            <input type="number" id="txtPorcentaje" name="txtPorcentaje" class="form-control" required="" aria-required="true" value="2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarReporteComisionVendedorExcel();" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar reporte</button>&nbsp;&nbsp;  
                                        <!--<button type="button" data-toggle="collapse" data-parent="#accordion1" href="#bg-info" onclick="buscarComisionVendedor()" value="enviar" class="btn btn-purple"><i></i>&ensp;Buscar</button>&nbsp;&nbsp;-->
                                        <button type="button" href="#bg-info" onclick="buscarComisionVendedor(1)" value="enviar" class="btn btn-purple"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                <div style="clear:left">
            ...
            <div class="modal-dialog modal-full"> 
                <div class="modal-content"> 
                    ...
                    <div class="modal-body"> 
                        <div class="table">
                            <div id="dataList">
                                <table id="datatableDocumentoComisionVendedor" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>                                            
        ...
        <script src="vistas/com/reporteVentas/comisionVendedor.js"></script>
    </body>
</html>
