...
function cargarDatosImprimir(data, volver)
{
    ...
    if(documentoTipo==45 || documentoTipo==18) {
        ...
        try {
            ...
            } else if (data.dataDocumento[0].identificador_negocio == 2) {// 2: orden de venta
...
//                    break;
                ...
                case 855://motivo de traslado  
                    switch (item.valor) {
                        case "Compra":   $('#celdaCompra').append("x");
                            break;
                        case "Consignación":   $('#celdaConsignacion').append("x");
                            break;
                        case "Devolución":   $('#celdaDevolucion').append("x");
                            break;
                        case "Emisor itinerante":   $('#celdaEmisor').append("x");
                            break;
                        case "Entre establecimientos de la misma empresa":   $('#celdaEntreEstablecimiento').append("x");
                            break;
                        case "Exportación":   $('#celdaExportacion').append("x");
                            break;
                        case "Importación":   $('#celdaImportacion').append("x");
                            break;
                        case "Otros":   
                        case "Cruce de stock":
                            $('#celdaOtros').append("x");
                            break;
                        case "Para transformación":   $('#celdaParaTransformacion').append("x");
                            break;
                        case "Recojo bienes transformados":   $('#celdaRecojoBienes').append("x");
                            break;
                        case "Venta":   $('#celdaVenta').append("x");
                            break;
                        case "Venta sujeta a confirmar":   $('#celdaVentaSujetaConfirmar').append("x");
                            break;
                        case "Zona Primaria":   $('#celdaZonaPrimaria').append("x");
                            break;
                        default:
                            break;                            
                    }                    
