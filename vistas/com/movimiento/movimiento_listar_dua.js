...
function cargaDataTableCif(dtNombre, cifData){
    $('#'+dtNombre).dataTable({
        ...
        footerCallback: function ( row, data, start, end, display ) {
                ...
                // Update footer
           $( api.column(2).footer() ).html(formatearNumero(api.column(2).data().length!=0? api.column(2).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(3).footer() ).html(formatearNumero(api.column(3).data().length!=0? api.column(3).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(4).footer() ).html(formatearNumero(api.column(4).data().length!=0? api.column(4).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(5).footer() ).html(formatearNumero(api.column(5).data().length!=0? api.column(5).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(6).footer() ).html(formatearNumero(api.column(6).data().length!=0? api.column(6).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(7).footer() ).html(formatearNumero(api.column(7).data().length!=0? api.column(7).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(8).footer() ).html(formatearNumero(api.column(8).data().length!=0? api.column(8).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(9).footer() ).html(formatearNumero(api.column(9).data().length!=0? api.column(9).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(10).footer() ).html(formatearNumero(api.column(10).data().length!=0? api.column(10).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           $( api.column(11).footer() ).html(formatearNumero(api.column(11).data().length!=0? api.column(11).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
        }, 
        "destroy": true
    });
}
...
//<!--Proveedor	Fecha	Concepto	US$ Valor venta	IGV	Total Compra	T/C	S/. Valor venta	IGV	Total Compra-->	        
        ...
        setTimeout(function(){ llenarDataTablaPlanillaImportacion(data.planillaImportacion); }, 500);
...
function parametrosDataTablePrecioCostoDolar(data){              
        ...
        var footerCallback= function ( row, data, start, end, display ) {
           ...
           eval(cadena);
           cont++;
           $( api.column(cont).footer() ).html(formatearNumero(api.column(cont).data().length!=0? api.column(cont).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           cont++;
           $( api.column(cont).footer() ).html(formatearNumero(api.column(cont).data().length!=0? api.column(cont).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
           cont++;
           $( api.column(cont).footer() ).html(formatearNumero(api.column(cont).data().length!=0? api.column(cont).data().reduce(function (a, b) {return intVal(a) + intVal(b);}):0));
...
function actualizarAnchosTablaColumnas(dataTable){
    setTimeout(function(){ mostrarTablaColumnasAjustadas(dataTable);}, 50);    
}
