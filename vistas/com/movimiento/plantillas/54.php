<html lang="es">
    <head>
        ...
        <title>Impresion devolución</title>
    </head>
    <body>
        <div id="dataImprimir">
            <div>
                ...
                <div id="titulo">
                    <p style="padding-top: 10px;"><b>DEVOLUCIÓN</b></p>
                    <p id="numeroDevolucion"><b>Número: </b></p> 
                </div>
            </div> 
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <p id="direccionPersonaDevolucion">
                                <b>Dirección: </b>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p id="codigoIdentificacionPersonaDevolucion"><b>DNI/RUC: </b></p>
                        </td>
                        <td style="text-align: center;">
                            <p id="fechaDevolucion"><b>Fecha: </b></p>
                        </td>
