<html lang="es">
    <head>
        ...
        <title>Impresion inventario</title>
    </head>
    <body>
        <div id="dataImprimir">
            <div>
                ...
                <div id="titulo">
                    <p style="padding-top: 10px;"><b>INVENTARIO</b></p>
                    <p id="numeroInventario"><b>Número: </b></p> 
                </div>
            </div> 
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <td>
                            <p id="tipoInventario"><b>Tipo de inventario: </b></p>
                        </td>
                        <td style="text-align: center;">
                            <p id="fechaInventario"><b>Fecha: </b></p>
                        </td>
