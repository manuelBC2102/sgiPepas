    ...
    <body>
        <div id="dataImprimir">
            ...
            <div class="cabeceraTabla">
                <div class="cabeceraTablaCelda cabeceraValidezOferta" id="cabeceraValidezOferta"></div>
                <div class="cabeceraTablaCelda cabeceraTiempoEntrega" id="cabeceraTiempoEntrega"></div>
                ...
                <div class="cabeceraTablaCelda cabeceraContacto" id="cabeceraContacto"></div>
                <div class="cabeceraTablaCelda cabeceraTelefono" id="cabeceraTelefono"></div>
            </div>
