    ...
    <body>
        <div id="dataImprimir">
            ...
            <div class="cabeceraCotizacionVenta">
                ...
                <div class="cotizacionVentaCelda">
                    <div class="anchoCotizacionVenta1">ÚTILES DE ESCRITORIO E INGENIERÍA, PAPELERÍA Y FORMAS CONTINUA</div>
                    <div class="anchoCotizacionVenta2" id="empresaRUC"></div>
                </div>
                <div class="cotizacionVentaCelda">
                    <div class="anchoCotizacionVenta1">SUMINISTROS PARA COMPUTADORAS</div>
                    <div class="anchoCotizacionVenta2" id="empresaDireccion1"></div>
                </div>
                <div class="cotizacionVentaCelda">
                    <div class="anchoCotizacionVenta1">TONER Y TINTAS PARA FOTOCOPIADORAS E IMPRESORAS</div>
            ...
            <div class="pieImportes">
                <div class="detalleRow" id="detalleRow0">
                    ...
                    <div class="detalleRowPU" style="text-align: center" >Total</div>
