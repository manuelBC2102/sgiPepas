                                            ...
                                            <div id="contenedorPercepcionDiv" hidden="true">
                                                <h4 id="contenedorPercepcion">
                                                    <div class="input-group m-t-10">
                                                        ...
                                                        <input type="number" id="txt_percepcion" name="txt_percepcion" readonly="true" class="form-control" value="" maxlength="25" onkeyup="if(this.value.length>25){this.value=this.value.substring(0,25)}" style="text-align: center;">
...
<!--                                                    <input type="checkbox" id="chkPercepcion" onclick="onChangeCheckPercepcion();">  
                                        ...
                                        <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>   
                                            <div id="contenedorSubTotalDiv" hidden="true">                                 
                                                ...
                                                <median class="text-uppercase">B.Imponible para IGV</median>                 
                                            </div>                                      
                                        </div>
