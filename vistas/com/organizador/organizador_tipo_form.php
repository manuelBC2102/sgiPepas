...
<!--        <section class="content">-->
            ...
            <div class="col-md-12 ">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-12 ">
                            <div class="panel-body">
                                <form  id="frm_organizador_tipo"  method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <button type="button" onclick="guardarOrganizadorTipo('<?php echo $tipo; ?>')" value="buscar" name="env" id="env" class="btn btn-info w-sm m-b-5" style="border-radius: 0px;"><i class="fa fa-send-o"></i>&ensp;Enviar</button>&nbsp;&nbsp;
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <script src="vistas/com/organizador/organizador_tipo.js"></script>
        <script>
            cargarSelect2();
//            loaderClose();
        </script>
