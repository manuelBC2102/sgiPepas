...
<?php
if (isset($_GET['tipo'])) {
    echo ' var tipo_busquedad = ' . $_GET['tipo'] . ';';
} else {
    echo ' var tipo_busquedad = null;';
}
?>
</script>
                        ...
                        <div class="portlet-body">
                            <div class="row">                                       
                                <div class="form-group col-md-6 ">
                                    <label id="lblCboPeriodo">Periodo</label>
...
<script src="vistas/com/reporteContabilidad/estado_financiero_naturaleza.js?<?php echo date("YmdHms"); ?>"></script>
