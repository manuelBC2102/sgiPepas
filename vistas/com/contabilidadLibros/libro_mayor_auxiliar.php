...
<!--                                <tfoot>
    ...
    <!--</div>-->
        <!--MODAL VER LIBRO DIARIO-->
        <div id="modalVerLibroDiario"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-full"> 
                <div class="modal-content"> 
                    <div class="modal-header"> 
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
                        <h4 class="modal-title">Detalle de libro Diario</h4>
                    </div> 
                    <div class="modal-body"> 
                        <div class="row">
                            <div class="panel panel-default">
                                <div class="panel panel-body">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-6" id="div_numero"></div>
                                            <br></br>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div id="dataListLibroDiario" class="table">
                ...
                <div class="modal-content"> 
                    ...
                    <div class="modal-body"> 
                        <div class="row">
                            <label>Glosa *</label>
                            <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <textarea type="text" id="txtGlosaFormEdit" name="txtGlosaFormEdit" rows="5" value="" maxlength="500" style="height: auto;width: 100%;display: block;padding: 6px 12px; border-color:#ddd" readonly=true></textarea>
                            </div>
