...
<div class="row">
    <div class="panel panel-default" style="padding-bottom:  5px;">
        <a href="#" style="border-radius: 0px;" class="btn btn-success w-md" onclick="preparaGenerarExcel()"><i class="fa fa-file-excel-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Generar excel</a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Generar libro</h4>
                </div>
                <div  class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btnGenerar" class="btn btn-info" onclick="generar()"><i class="fa fa-save" value="" >&nbsp;&nbsp;</i>Generar</button>
    ...
    <div id="modalCalculoSaldo" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 id="tlSaldoCompras" class="modal-title">Saldo de compras</h4>
                </div>
                <div  class="modal-body">
                    <div id="dataListSaldos" class="row">
...
<script src="vistas/com/contabilidadLibros/inv_perm_valorizado.js"></script>
