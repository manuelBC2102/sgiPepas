                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" onclick="exportarRegistroVentasSire();" value="Exportar" name="env" id="env" class="btn btn-primary w-md" style="border-radius: 0px;">&ensp;Exportar SIRE</button>&nbsp;&nbsp;  
