    ...
    <head>
        ...
        if ($tipo == 1) {
            ...
            <script language="javascript">
                getBienMotivoSalida(<?php echo $id; ?>);
            </script>
            <?php }
        ?>
    </head>
                                ...
                                <form  id="frm_bien_tipo"  method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <a href="#" class="btn btn-danger m-b-5" id="id" style="border-radius: 0px;" onclick="cargarDiv('#window', 'vistas/com/bien/bien_motivo_salida_listar.php')" ><i class="fa fa-close"></i>&ensp;Cancelar</a>&nbsp;&nbsp;&nbsp;
                                            <button type="button" onclick="guardarBienMotivoSalida('<?php echo $tipo; ?>')" value="buscar" name="env" id="env" class="btn btn-info w-sm m-b-5" style="border-radius: 0px;"><i class="fa fa-send-o"></i>&ensp;Enviar</button>&nbsp;&nbsp;
                                        </div>
                                    </div>
                                </form>
                            </div>
