...
function onResponseObtenerConfiguracionesIniciales(data) {
    if (!isEmpty(data.documento_tipo)) {
        ...
        if (doc_TipoId == REQUERIMIENTO_AREA || doc_TipoId == GENERAR_COTIZACION || doc_TipoId == GENERAR_COTIZACION_SERVICIO) {
            $("#ver_filas").hide();
        }
    ...
    if (doc_TipoId == GENERAR_COTIZACION || doc_TipoId == GENERAR_COTIZACION_SERVICIO) {
        ...
        $.each(dataColumna, function (index, item) {
            switch (parseInt(item.codigo)) {
                ...
                case 13://Unidad de medida
                    ...
                    break;
                case 14://Acciones
                    if ((doc_TipoId == GENERAR_COTIZACION || doc_TipoId == GENERAR_COTIZACION_SERVICIO) && !isEmpty(arrayProveedor)) {
...
function agregarUnidadMedidaDetalleTabla(i) {
    var disabled = '';
    if (doc_TipoId == GENERAR_COTIZACION || doc_TipoId == REQUERIMIENTO_AREA || doc_TipoId == COTIZACION_SERVICIO || doc_TipoId == GENERAR_COTIZACION_SERVICIO) {
        disabled = 'disabled';
    }
    var $html = "<div class=\"input-group col-lg-12 col-md-12 col-sm-12 col-xs-12\">" +
            ...
            switch (parseInt(item.tipo)) {
                ...
                case 42:
                    ...
                    if (!isEmpty(item.data)) {
                        ...
                        if (doc_TipoId == GENERAR_COTIZACION || doc_TipoId == REQUERIMIENTO_AREA || doc_TipoId == GENERAR_COTIZACION_SERVICIO) {
...
function cargarPantallaListarServicio() {
    cargarDiv("#window", "vistas/com/compraServicio/servicio_listar.php?tipoInterfaz=" + tipoInterfaz);
}
...
function onResponseObtenerDocumentoRelacion(data) {
    ...
    if (data.documentoACopiar[0].documento_tipo_descripcion == "Solicitud requerimiento" && (doc_TipoId == GENERAR_COTIZACION || doc_TipoId == GENERAR_COTIZACION_SERVICIO)) {
    ...
    if (doc_TipoId == GENERAR_COTIZACION || doc_TipoId == COTIZACION_SERVICIO || doc_TipoId == GENERAR_COTIZACION_SERVICIO) {
        ...
        $.each(dataColumna, function (index, item) {
            ...
            switch (parseInt(item.codigo)) {
                ...
                case 11:// PRODUCTO
                    ...
                    if (doc_TipoId == GENERAR_COTIZACION || doc_TipoId == REQUERIMIENTO_AREA || doc_TipoId == COTIZACION_SERVICIO || doc_TipoId == SOLICITUD_REQUERIMIENTO || doc_TipoId == GENERAR_COTIZACION_SERVICIO) {
...
function dibujarBotonesDeEnvio(data) {
    ...
    var html = '<a href="#" class="btn btn-danger" onclick="cargarPantallaListarServicio()"><i class="fa fa-close"></i> Cancelar</a>';
    var accion = '';
    var estilo = '';
    ...
    if (!isEmpty(data.accionesEnvio)) {
        ...
        $.each(accion, function (index, item) {
            estilo = '';
            if ((doc_TipoId == GENERAR_COTIZACION || doc_TipoId == GENERAR_COTIZACION_SERVICIO) && item.funcion != "generar") {
