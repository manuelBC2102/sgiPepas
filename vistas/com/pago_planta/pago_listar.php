            ...
            <table id="datatable" class="table table-striped table-bordered" >
                <thead>
                    <tr>
                        ...
                        <th style='text-align:center;'>Responsable pagado</th>
                        <th style='text-align:center;'>Planta</th>
                        <th style='text-align:center;'>Facturas pagadas</th>
                        <!-- <th style='text-align:center;'>Zona</th> -->
                        <th style='text-align:center;'>Monto</th>
                        <th style='text-align:center;'>Numero operación</th>
                        <th style='text-align:center;'>Imagen pago</th>
...
<script src="vistas/com/pago_planta/pago_listar.js"></script>