...
function onResponseAjaxpGetDataGridSolicitudes(data) {
    ...
    var cabeza = '<table id="datatable" class="table table-responsive table-striped table-bordered"><thead>' +
        ...
        "<th style='text-align:start;'>REINFO</th>" +
 ...
 function listarPersona(){
    ax.setAccion("listarSolicitudes");
    ax.consumir();
 }
...
//     ax.setAccion("getDataGridSolicitudesAprobacion");
//      if(id==null){
...
//                 render: function (data, type, row) {
//                     if (type === 'display') {
//                         return '<a onclick="aprobarSolicitud(' + row.id + ')"><b><i class="fa fa-check " style="color:blue;"></i><b></a>';
//                     }
//                     return data;
//                 },
//                 "orderable": true,
...
function aprobarSolicitud(id) {
    ...
    cargarDiv("#window", "vistas/com/solicitudRetiro/aprobacion_solicitud_form.php", "Gestionar Solicitud");
}

function aprobarSolicitudPlanta(id) {
    loaderShow(null);
    commonVars.personaId = id;
    cargarDiv("#window", "vistas/com/solicitudRetiro/aprobacion_planta_solicitud_form.php", "Gestionar Solicitud");
}
