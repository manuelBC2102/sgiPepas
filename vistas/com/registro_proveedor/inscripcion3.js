...
function buildTable(data) {
    ...
    let tableHTML = `
        <table id="coordinatesTable" class="table table-bordered">
            <thead>
                <tr style="background-color:#244061; color:white;">
                    <th style="text-align:center; width: 10%;">#</th>
                     <th style='text-align:center; width: 20%;'>Placa</th>
                    <th style='text-align:center; width: 20%;'>Carga Útil</th>
                     <th style='text-align:center; width: 20%;'>Marca</th>
                    <th style='text-align:center; width: 20%;'>Modelo</th>
    ...
    defaultData.forEach((item, index) => {
        ...
        `` : 
        `<button type="button" class="btn btn-danger btn-sm" onclick="removeSpecificRow(this)">Eliminar</button>`;
...
function guardarInvitacion() {
    ...
    ax.consumir();
        ...
        function addRow() {
            if (document.querySelectorAll('#coordinatesBody tr').length < 20) {
                const tbody = document.getElementById('coordinatesBody');
                const row = document.createElement('tr');
                row.innerHTML = `
                    <td style="text-align:center;"></td>
                    <td style="text-align:left;"><input type="text" class="form-control" maxlength="7" placeholder="placa" required /></td>
                    <td style="text-align:left;"><input type="number" class="form-control" placeholder="carga útil" required /></td>
                     <td style="text-align:left;"><input type="text" class="form-control" placeholder="marca" required /></td>
                      <td style="text-align:left;"><input type="text" class="form-control" placeholder="modelo" required /></td>
                ...
                alert('Puedes agregar un máximo de 20 vehículos.');
            }
        }
