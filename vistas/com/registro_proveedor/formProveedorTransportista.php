...
<div class="panel-group panel-group-joined" id="accordion-test">
   ...
   <div id="dataList2" >
    ...
    <div class="modal-footer">
                    ...
                    <button type="button" id="btnEnviar" onclick="guardarInvitacion();" class="btn btn-info" data-toggle="reload"><i class="fa fa-send-o"></i> Enviar</button>
                </div>
    <!--fin adicional-->
</div>
