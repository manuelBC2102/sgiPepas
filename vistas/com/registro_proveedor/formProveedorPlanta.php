                        ...
                        <tbody>
                           <tr>
                                <td style="vertical-align: middle; width: 17%">
                                    <label>Fecha inscripción <span id="spNombreCom"></span></label>
                                </td>
                                <td colspan="5">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
   ...
   <div id="dataList2" >
    ...
    <div class="row" style="margin-left: 8px;">
        ...
        <div class="panel-heading">
            <h4 class="panel-title">
                <!--<a data-toggle="collapse" data-parent="#accordion-test" href="#collapseOne">-->
                III. Documentos solicitados a REINFO
                <!--</a>-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="cboTipoArchivo2" style="width: 100%;" id="cboTipoArchivo2"
                                                            class="select2 ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6" id="uploadField"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <img id="myImg3" src="vistas/com/persona/imagen/documento-none.png"
    ...
    <div id="dataList3" >
        ...
        <!-- <button type="button" class="btn btn-info btn-submit" onclick="addRow()">Agregar vehículo</button> -->
        <!-- <button type="button" class="btn btn-danger btn-submit" onclick="removeRow()">Eliminar Coordenada</button>
        <button type="button" class="btn btn-primary btn-submit" onclick="saveData()">Guardar</button> -->
    </div> 
    <br><br>
    <div class="row" style="margin-left: 8px">
        <center>
