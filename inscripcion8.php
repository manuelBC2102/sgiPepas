...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-10 col-xs-10">
            <div class="panel panel-body">
                <?php include "vistas/com/registro_proveedor/formProveedorAsociativa2.php"; ?>
    ...
    <script src="<?php echo $url_base; ?>vistas/com/registro_proveedor/inscripcion8.js?<?php echo date("YmdHms"); ?>"></script>
