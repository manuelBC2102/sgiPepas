...
if ($f_o=='Grabacion') {
	...
	$resul = 'enviada a Administraci&oacute;n para su revisi&oacute;n, verificaci&oacute;n y visto bueno';
}
else {
...
<?php include ("header.php"); ?>
    ...
    <h1>Revisar liquidaci&oacute;n  <?php echo strtolower(getNomZona($zona_id)); ?></h1>

<p>Estado: Su liquidaci&oacute;n <?php echo $ear_numero; ?> ha sido <?php echo $resul; ?>.<br></p>

<p><a href="ear_aprobacion.php">Regresar a Aprobaci&oacute;n de Entregas a rendir</a><br></p>
