...
<title>Revisar Liquidacion Caja Chica (Responsable) - Administraci�n - Minapp</title>
<style type="text/css">
...
<h1>Revisar Liquidacion Caja Chica (Responsable)</h1>
...
<form id="liquidacion" action="cch_lote_revision_p.php" method="post">
...
<input type="submit" value="Grabar Lote" name="grabar" id="grabar" disabled> <input type="submit" value="Aprobar Lote" name="aprobar" id="aprobar" disabled>
