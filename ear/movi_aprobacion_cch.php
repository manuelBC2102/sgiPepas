...
<head>
<title>Aprobar Planillas de Movilidad de Caja Chica - Administraci�n MinappES</title>
<style type="text/css">
...
<h1>Aprobar Planillas de Movilidad de Caja Chica</h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	...
	<tbody>
<?php
$arr = getPlanillasMovilidadCCH($god_mode, 1, $_SESSION['rec_usu_id']);
...
foreach ($arr as $v) {
	...
	echo "<a href='movi_consulta_detalle.php?id=".$v['pla_id']."&opc=13'><img src='img/liquidar.png' border='0' title='Revisar' class='iconos'></a>\n";
	echo "<a href='movi_anular_p.php?id=".$v['pla_id']."&cch=1' onClick=\"return confirm('Est&aacute; seguro que desea anular la planilla?')\"><img src='img/opc-no.gif' border='0' title='Anular' class='iconos'></a>\n";
	echo "</td>\n";
...
<p><b>Leyenda:</b>
	...
	<img src='img/liquidar.png' title='Revisar'> Revisar la planilla &nbsp;&nbsp;&nbsp;
