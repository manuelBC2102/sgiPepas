...
$stmt = $mysqli->prepare("INSERT INTO usu_reg_otro VALUES (null, ?, ?, ?)") or die ($mysqli->error);
$stmt->bind_param('iii',
	$master,
	$slave,
	$act);
...
$desc = "Nuevo registrar por otro usuario ($id), master $master, slave $slave, activo $act, hecha por ".$_SESSION['rec_usu_nombre'];
