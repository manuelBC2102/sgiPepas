...
$stmt = $mysqli->prepare("INSERT INTO cajas_chicas_resp VALUES (null, ?, ?, ?)") or die ($mysqli->error);
$stmt->bind_param('iii',
	$cch,
	$usu,
	$act);
...
$desc = "Nuevo registrar responsable caja chica ($id), caja $cch, usuario $usu, activo $act, hecha por ".$_SESSION['rec_usu_nombre'];
