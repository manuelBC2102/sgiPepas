...
<head>
<title>Mantenedor Proveedores - Administraci�n MinappES</title>
<style type="text/css">
...
<script>
function editar(id) {
	location.href="mant_proveedores_edit.php?id="+id;
}
</script>
<style>
.iconos {
...
<h1>Mantenedor Proveedores <a href="mant_proveedores_new.php"><img src="img/new_icon24.png" border="0" title="Registrar nuevo proveedor"></a></h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	<thead>
		<tr>
			...
			<th>Nombre</th>
			<th>Activo</th>
			<th title='Agente Retenci�n'>Ret</th>
			<th>Habido</th>
			<th title='Emite Facturas'>Factura</th>
			<th>Provincia</th>
			<th title='Ultima fecha de revisi�n'>Revisado</th>
			<th>Acciones</th>
		</tr>
	</thead>
	<tbody>
<?php
$arr = getProveedoresLista($max);
