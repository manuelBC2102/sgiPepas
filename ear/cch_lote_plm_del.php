...
<head>
<title>Quitar Planillas de Movilidad de Caja Chica - Administraci�n MinappES</title>
<style type="text/css">
...
<h1>Quitar Planillas de Movilidad de Caja Chica</h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	...
	<tbody>
<?php
$arr = getPlanillasMovilidadCCH($god_mode, 3, $_SESSION['rec_usu_id']);
...
foreach ($arr as $v) {
	...
	echo "\t\t<td>".$v['ccl_numero']."</td>\n";

	echo "\t\t<td>";
	echo "<a href='movi_consulta_detalle.php?id=".$v['pla_id']."&opc=1'><img src='img/search.png' border='0' title='Consultar' class='iconos'></a>\n";
	echo "<a href='cch_lote_plm_del_p.php?id=".$v['pla_id']."' onClick=\"return confirm('Est&aacute; seguro que desea quitar la planilla?')\"><img src='img/opc-no.gif' border='0' title='Quitar' class='iconos'></a>\n";
	echo "</td>\n";
...
<p><b>Leyenda:</b>
	...
	<img src='img/opc-no.gif' title='Quitar'> Quitar la planilla &nbsp;&nbsp;&nbsp;
</p>
