...
<head>
<title>Editar responsable de caja chica - Administraci�n MinappES</title>
<style type="text/css">
...
<h1>Editar responsable de caja chica</h1>

<b>Datos del responsable de caja chica:</b><br>

<br>

<form action="mant_cajas_chicas_resp_edit_p.php" method="post" enctype="multipart/form-data">
<table>
<tr>
...
<tr>
	...
	<td>
		<select name="act">
			<option value="1"<?php echo ($ccr_act==1?' selected':''); ?>>Si</option>
			<option value="0"<?php echo ($ccr_act==0?' selected':''); ?>>No</option>
		</select>
	</td>
</tr>
