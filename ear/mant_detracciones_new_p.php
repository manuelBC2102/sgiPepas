...
$stmt = $mysqli->prepare("INSERT INTO detracciones VALUES (null, ?, ?, ?, ?)") or die ($mysqli->error);
...
$desc = "Nueva detraccion ($id), cod $cod, aplica desde $fec, tasa $tas, monto minimo $min, hecha por ".$_SESSION['rec_usu_nombre'];
