...
<title>Registrar nueva caja chica - Administraci�n - Minapp</title>
<style type="text/css">
...
<h1>Registrar nueva caja chica</h1>

<b>Datos de la caja chica:</b><br>

<br>

<form action="mant_cajas_chicas_new_p.php" method="post" enctype="multipart/form-data">
<table>
<tr><td align="right">Nombre:</td><td><input type="text" id="nom" name="nom" maxlength="80" size="120" /></td></tr>
<tr>
...
<tr><td align="right">Monto inicial:</td><td><input type="text" id="mont" name="mont" maxlength="13" size="20" /></td></tr>
<tr><td align="right">Abreviatura:</td><td><input type="text" id="abrv" name="abrv" maxlength="32" size="20" /></td></tr>
...
<tr><td align="right">Cuenta bancaria:</td><td><input type="text" id="cta" name="cta" maxlength="32" size="20" /></td></tr>
<tr>
