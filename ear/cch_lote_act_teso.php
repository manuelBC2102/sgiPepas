...
<head>
<title>Caja Chica actualizar Liquidaciones con reembolsos pendientes - Administraci�n MinappES</title>
<style type="text/css">
...
$(document).ready(function()
{
	$('.cch_liq_act').click(function(){
		var msj = 'Verifique si ha sido realizado correctamente el reembolso.\n\nEsta seguro de actualizar?\n\n';
		...
		location.href="cch_lote_act_tesocomp_p.php?id="+ccl_id+"&oper=1";
	});
});
</script>
...
<h1>Caja Chica actualizar Liquidaciones con reembolsos pendientes</h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	...
	<tbody>
<?php
$arr = getLotesCajaChicaLista(6);

foreach ($arr as $v) {
	$total_usado = number_format($v[31], 2, '.', '');;
	...
	echo "<span class='cch_liq_act' fila='$v[0]' style='cursor: pointer'><img src='img/money-bag-dollar.png' border='0' title='Actualizar' class='iconos'></span>\n";
	echo "</td>\n";
...
<p><b>Leyenda:</b>
	...
	<img src='img/money-bag-dollar.png' title='Actualizar'> Actualizar &nbsp;&nbsp;&nbsp;
</p>
