...
$arr = getLiqDesembolsadas($_SESSION['rec_usu_persona_id']);
...
<h1>Registro de planilla de movilidad</h1>

<form id="form1" action="movi_solicitud_p.php" method="post">

<table>
<tr><td align="right">Nombre colaborador:</td><td><?php echo $nombres.' '.$apePaterno.' '.$apeMaterno; ?></td></tr>
