...
$stmt = $mysqli->prepare("INSERT INTO paginas_permisos VALUES (null, ?, ?)") or die ($mysqli->error);
$stmt->bind_param('ii',
	$grp,
	$usu);
$stmt->execute() or die ($mysqli->error);
...
$desc = "Nuevo registrar permiso ($id), grupo $grp, usuario $usu, hecha por ".$_SESSION['rec_usu_nombre'];
