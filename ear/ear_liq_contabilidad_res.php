...
if ($f_o=='Actualizacion') {
	$resul = 'actualizada exitosamente';
}
else {
...
<title>Control Contabilidad - Liquidaci�n EAR - Administraci�n - Minapp</title>
<style type="text/css">
...
<h1>Control Contabilidad - Liquidaci�n de Vi�ticos y/o Entregas a Rendir (EAR) <?php echo getNomZona($zona_id); ?></h1>

<p>Estado: La liquidaci�n <?php echo $id; ?> ha sido <?php echo $resul; ?>.<br></p>

<p><a href="ear_contabilidad.php">Regresar a Control Contabilidad - Liquidaci�n de Entregas a Rendir</a><br></p>
