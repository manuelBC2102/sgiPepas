...
//VALIDAR SI EL SOLICITANTE ES UN PROVEEDOR EAR (DUA)
    ...
    $(document).ready(function() {
      ...
      $.fn.checktopes_redraw = function() {
        ...
        $('#alim_body .fecha_inp').each(function() {
          ...
          //                        monto = afecto + (factor*noafecto) +otro;
          //			monto = afecto + noafecto + otro;
      ...
      $.fn.tc_afec_redraw = function(fila) {
        ...
        switch (afecto_sel) {
          ...
          case 2:
            ...
            fila.children('.monto_igv_td').children('.monto_igv').val('18');
            break;
          case 3:
            fila.children('.afecto_td').children('.afecto_inp').hide();
            fila.children('.afecto_td').children('.afecto_inp').val('');
        ...
        switch (afecto_sel) {
          ...
          case 2:
          case 5:
            fila.children('.monto_igv_td').children('.monto_igv').val('10');
            break;
          case 3:
            fila.children('.monto_igv_td').children('.monto_igv').val('0');
            break;
      ...
      $.fn.ret_det_recalc = function(fila) {
        ...
        var monto_ibcp = parseFloat(fila.children('.montIcbp_td').children('.montIcbp_inp').val());
        var mon_id_sel = parseInt(fila.children('.tipo_mon_td').children('.tipo_mon').val());
        ...
        if (mon_id_sel == mon_id) {
          ...
          fila.children('.conv_icbp_td').children('.conv_icbp_inp').val(monto_ibcp);
          ...
          if (mon_id_sel == 2 && mon_id == 1) {
            ...
            var monto_conv_ibcp = factor * (monto_ibcp * tc_inp) || 0;
            var monto_conv_otro = factor * (monto_otro * tc_inp) || 0;
            var conv_conc_det_minmonto = conc_det_minmonto / tc_inp;
            var conv_ret_minmonto = ret_minmonto / tc_inp;
          ...
          fila.children('.conv_icbp_td').children('.conv_icbp_inp').val(monto_conv_ibcp.toFixed(2));
        }
      ...
      $.fn.totalizar_recalc = function() {
        ...
        var mon_abodes = mon_saldo + tot_mon_gast_asum2;
        var resul_msg = "";
        var resul_inp = 0;
        switch (true) {
          case (mon_abodes == 0):
      ...
      $.fn.tabla_tipo_nota = function($tbl) {
        ...
        if (cve == 0) {
          ...
          $tbl.children('.det_doc_td').children('.det_doc_inp').show();
        } else if (cve == 1) {
      ...
      $.fn.tipo_notaf = function() {
        ...
        switch (true) {
                    case (IdenBody == 1):
                        ...
                        var ser =$(this).parent().parent().children('.ser_doc_td').children('.ser_doc_inp').val();
                        var num =$(this).parent().parent().children('.num_doc_td').children('.num_doc_inp').val();
                        if (ruc == '' || ruc == null) {  alert("Ingresar el ruc");}
                        else if (ser == '0' || ser == null) { alert("Debe ingresar la serie"); }
                        else if (num == '0' || num == null) { alert("Debe ingresar el numero");}
                        else{
                            var $tbl = fila_id;
                            var ruc_nro_t = $('#ruc_nro_template').html();
                            var prov_nom_t = $('#prov_nom_template').html();
                            ...
                            var gast_asum_t = $('#gast_asum_template').html();
                            var dele = '<img src="img/delete.png" class="dele" title="Borrar">&nbsp;';
                            var agregarDistribucion = '&nbsp;<input type="hidden" value=""  id="lid_distribucion[{0}]" name="lid_distribucion[{0}]" /><img src="img/plus.png"  onclick="abrirModalDistribucion(\'[{0}]\',\'01\')" title="Agregar distribucion contable">&nbsp;';
                            var s_add = '<tr class="fila_dato">';
                            s_add += '<td class="conc_td">'+conc_t+'</td>'; //Concepto
                            s_add += '<td class="tipo_doc_td">'+tipo_doc_t+'</td>'; //Tipo Doc
        ...
        if ($tbl =='' || $tbl == null) {
        }else{$(document).tabla_tipo_nota($tbl); }
      ...
      $(document).ready(function() {
        ...
        $('.afecto_inp').each(function() {
          ...
          $(this).parent().parent().children('.montIcbp_td').children('.montIcbp_inp').rules('add', {
            //				min: 0.01
          });
      ...
      s_afeconretdet += "<td class='monto_igv_td'><input type='hidden' value='0' id='monto_igv[{0}]' name='monto_igv[{0}]' readonly></td>"; // Monto IGV
      ...
      $('#bole_add').click(function() {
        ...
        var conc_t = $('#bole_conc_template').html();
        var tipo_doc_t = $('#tipo_doc_template').html();
        var orden_t =  '&nbsp;<input type="hidden" value=""  id="lid_orden_trabajo[{0}]" name="lid_orden_trabajo[{0}]" /><label id="des_orden_trabajo[{0}]" name="des_orden_trabajo[{0}]"></label>&nbsp;<img class="orden_trabajo" src="img/plus.png"  onclick="abrirModalOrdenTrabajo(\'[{0}]\')" title="Agregar Orden de Trabajo">&nbsp;';
        var tipo_mon_t = $('#tipo_mon_template').html();
        var aprob_t = $('#aprob_template').html();
        var gast_asum_t = $('#gast_asum_template').html();
        var dele = '<img src="img/delete.png" class="dele" title="Borrar">&nbsp;';
      ...
      $('#movi_add').click(function() {
        ...
        var s_add = '<tr class="fila_dato" bandera="' + fila_id + '">';
        s_add += '<td class="conc_td">' + conc_t + '</td>'; //Concepto
        s_add += '<td class="tipo_doc_td">' + tipo_doc_t + '</td>'; //Tipo Doc
        s_add += '<td class="orden_t" style="white-space: nowrap;">' + orden_t + '</td>'; //Orden trabajo
        s_add += '<td class="ruc_nro_td">' + ruc_nro_t + '</td><td class="prov_nom_td">' + prov_nom_t + '</td>'; //RUC y Nombre Proveedor
...
<body>
  ...
  <form id="liquidacion" action="ear_liq_revision_p.php" method="post">
    ...
    <table border="1" id="doc_sust_detalle">
      <tbody id="bole_body">
        ...
        <?php echo getFilasPrevias($arrLiqDet, $mon_id, '01', 2, 1, $arrDistribucionDetalle); ?>
      </tbody>
      <tbody>
        <tr>
          <td colspan="25">Nueva fila Boletos de Viaje / Pasajes A&eacute;reos <img src="img/plus.png" id="bole_add" title="Agregar" class="iconos"></td>
        </tr>
      </tbody>
      ...
      <tbody id="alim_body">
        <tr>
          <td colspan="25">Alimentaci&oacute;n / Pensi&oacute;n</td>
        </tr>
        <tr>
          <td class="encabezado_h">Concepto</td>
          <td class="encabezado_h" title="Tipo de documento">Tipo Doc</td>
        ...
        <?php echo getFilasPrevias($arrLiqDet, $mon_id, '02', 2, 1, $arrDistribucionDetalle); ?>
      </tbody>
      <tbody>
        <tr>
          <td colspan="25">Nueva fila Alimentacion / Pension <img src="img/plus.png" id="alim_add" title="Agregar" class="iconos"></td>
        </tr>
      </tbody>
      ...
      <tbody id="hosp_body">
        ...
        <?php echo getFilasPrevias($arrLiqDet, $mon_id, '03', 2, 1, $arrDistribucionDetalle); ?>
      </tbody>
      <tbody>
        <tr>
          <td colspan="25">Nueva fila Hospedaje <img src="img/plus.png" id="hosp_add" title="Agregar" class="iconos"></td>
        </tr>
      </tbody>
      ...
      <tbody id="movi_body">
        ...
        <?php echo getFilasPrevias($arrLiqDet, $mon_id, '04', 2, 1, $arrDistribucionDetalle); ?>
      </tbody>
      <tbody>
        <tr>
          <td colspan="25">Nueva fila Movilidad / Combustible <img src="img/plus.png" id="movi_add" title="Agregar" class="iconos"></td>
        </tr>
      </tbody>
      ...
      <tbody id="gast_body" style="display: none;">
        <tr>
          <td colspan="25">Gastos de Representaci&oacute;n</td>
        </tr>
        <tr>
          <td class="encabezado_h">Concepto</td>
          <td class="encabezado_h" title="Tipo de documento">Tipo Doc</td>
        ...
        <?php echo getFilasPrevias($arrLiqDet, $mon_id, '05', 2, 1, $arrDistribucionDetalle); ?>
      </tbody>
      <tbody style="display: none;">
        <tr>
          <td colspan="25">Nueva fila Gastos de Representaci&oacute;n <img src="img/plus.png" id="gast_add" title="Agregar" class="iconos"></td>
        </tr>
      </tbody>
      ...
      <tbody id="otro_body">
        ...
        <?php echo getFilasPrevias($arrLiqDet, $mon_id, '06', 2, 1, $arrDistribucionDetalle); ?>
      </tbody>
      <tbody>
        <tr>
          <td colspan="25">Nueva fila Otros <img src="img/plus.png" id="otro_add" title="Agregar" class="iconos"></td>
        </tr>
      </tbody>
    </table>
    ...
    <input type="submit" value="Grabar Liquidacion" name="grabar" id="grabar" disabled> <input type="submit" value="Aprobar Liquidacion" name="aprobar" id="aprobar" disabled>

    <p>Descripci&oacute;n de los botones:<br>
      <b>Grabar</b> almacena los datos ingresados para continuar despu&eacute;s.<br>
      <b>Aprobar</b> transmite la liquidaci&oacute;n a administraci&oacute;n (Ya no podr&aacute; hacer m&aacute;s modificaciones).
    </p>
  ...
  <div id="modalOrdenTrabajo" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table border="1" id="table_orden" width=100%>
          <tbody id="orden_trabajo_body">
            <tr>
