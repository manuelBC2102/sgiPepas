...
if ($f_o=='Grabacion') {
	...
	$resul = 'enviada al Encargado para su posterior revisi�n, verificacion y aprobaci�n';
}
else if ($f_o=='Borrador') {
	$resul = 'grabada exitosamente <b>pero han ocurrido cambios con los documentos pendientes, si trato de cerrar y enviar la liquidacion esta operacion no ha sido realizada, revise nuevamente los totales y repetir la operacion</b>';
}
else {
...
<h1>Registro de Documentos Caja Chica</h1>

<p>Estado: Su liquidacion de caja chica <?php echo $ccl_numero; ?> ha sido <?php echo $resul; ?>.<br></p>

<p><a href="menu.php">Regresar a Menu de Administraci�n</a><br></p>
