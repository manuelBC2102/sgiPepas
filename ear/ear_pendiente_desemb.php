...
<head>
<!--<title>EAR pendientes de Desembolsar - Administraci�n - Minapp</title>-->
...
<h1>Desembolso (Solicitudes con desembolsos pendientes)</h1>
...
$query="SELECT e.ear_id,concat(ifnull(sp.nombre,''),' ',ifnull(sp.apellido_paterno,''),' ',ifnull(sp.apellido_materno,'')) as ear_tra_nombres,
...
while($fila=$result->fetch_array()){
	...
	echo "<a href='ear_pdf_sol.php?id=".$fila['ear_id']."' target='_blank'><img src='img/pdf.gif' border='0' title='Descargar PDF Solicitud EAR' class='iconos'></a>\n";
	echo "<a href='ear_pendiente_desemb_p.php?id=".$fila['ear_id']."' onClick=\"return confirm('Est&aacute; seguro que desea desembolsar?')\"><img src='img/money-bag-dollar.png' title='Desembolsar' border='0' class='iconos'></a> ";
	echo "</td>\n";
