...
<head>
<title>Mantenedor Permisos - Administraci�n MinappES</title>
<style type="text/css">
...
<script>
function editar(id) {
	location.href="mant_permisos_edit.php?id="+id;
}

function borrar(id, master, slave) {
	var valor=confirm('Est\u00e1 seguro que desea eliminar el permiso de '+master+' a '+slave+'?');

	if(valor==true) { location.href="mant_permisos_del_p.php?id="+id; }
}
</script>
<style>
.iconos {
...
<h1>Mantenedor Permisos <a href="mant_permisos_new.php"><img src="img/new_icon24.png" border="0" title="Registrar nuevo permiso"></a></h1>
