...
<head>
<title>Mantenedor Registrar Liquidaciones sin Solicitud - Administraci�n MinappES</title>
<style type="text/css">
...
<script>
function editar(id) {
	location.href="mant_usureglss_edit.php?id="+id;
}
...
function borrar(id, master, slave) {
	...
	if(valor==true) { location.href="mant_usureglss_del_p.php?id="+id; }
}
</script>
<style>
.iconos {
...
<h1>Mantenedor Registrar Liquidaciones sin Solicitud <a href="mant_usureglss_new.php"><img src="img/new_icon24.png" border="0" title="Registrar nuevo registrar liquidaciones sin solicitud"></a></h1>
