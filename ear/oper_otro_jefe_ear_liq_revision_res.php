...
if ($f_o=='Grabacion') {
	...
	$resul = 'enviada a Administraci�n para su revisi�n, verificacion y visto bueno';
}
else {
...
<h1>Revisar Liquidaci�n de Vi�ticos y/o Entregas a Rendir (EAR) <?php echo getNomZona($zona_id); ?></h1>

<p>Estado: Su liquidaci�n <?php echo $ear_numero; ?> ha sido <?php echo $resul; ?>.<br></p>

<p><a href="oper_otro_jefe_ear_aprobacion.php?otro_jefe_usu_id=<?php echo $otro_jefe_usu_id; ?>">Regresar a Aprobacion de Entregas a Rendir</a><br></p>
