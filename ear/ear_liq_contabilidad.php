...
<h1>Control Contabilidad - Liquidaci�n EAR <?php echo $zona_nom; ?></h1>
...
<form id="liquidacion" action="ear_liq_contabilidad_p.php" method="post">
...
<?php if(!is_null($pla_id)) echo getFilaPlanillaMovilidad($pla_id, $mon_id, 4); else echo getFilaVaciaPlaMov(2); ?>
...
<b>Actualizar</b> almacena los datos modificados.<br>
<b>Regresar</b> a la p�gina anterior. </p>
