...
<head>
<title>Mantenedor Marcas de Vehiculos - Administraci�n MinappES</title>
<style type="text/css">
...
<script>
function editar(id) {
	location.href="mant_veh_marcas_edit.php?id="+id;
}

function borrar(id, var01) {
	var valor=confirm('Est\u00e1 seguro que desea eliminar la marca de vehiculo '+var01+'?');

	if(valor==true) { location.href="mant_veh_marcas_del_p.php?id="+id; }
}
</script>
<style>
.iconos {
...
<h1>Mantenedor Marcas de Vehiculos <a href="mant_veh_marcas_new.php"><img src="img/new_icon24.png" border="0" title="Registrar nueva marca de vehiculo"></a></h1>
