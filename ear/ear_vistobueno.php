...
<head>
<title>EAR pendientes de Visto Bueno - Administraci�n MinappES</title>
<style type="text/css">
...
<script>
function vbfast(id, var1, var2) {
	var valor=confirm('Est\u00e1 seguro que desea dar visto bueno rapido a la liquidacion de '+var1+' ('+var2+')?');

	if(valor==true) { location.href="ear_liq_vbfast_p.php?id="+id; }
}
</script>
...
<h1>Entregas a Rendir (EAR) pendientes de Visto Bueno</h1>
...
while($fila=$result->fetch_array()){
	...
	echo "<a href='ear_liq_vistobueno.php?id=".$fila['ear_id']."'><img src='img/liquidar.png' title='Revisar Liquidaci�n' border='0' class='iconos'></a> ";
	echo "<img src='img/opc-si.gif' border='0' title='Visto Bueno r�pido' class='iconos' onclick='vbfast(\"".$fila['ear_id']."\", \"".$fila['ear_tra_nombres']."\", \"".$fila['ear_numero']."\");'>\n";
	echo "</td>\n";
...
<p><b>Leyenda:</b>
	...
	<img src='img/liquidar.png' title='Revisar Liquidaci�n' class='iconos'> Revisar Liquidaci�n &nbsp;&nbsp;&nbsp;
	<img src='img/opc-si.gif' title='Actualizar' class='iconos'> Visto Bueno r�pido &nbsp;&nbsp;&nbsp;
