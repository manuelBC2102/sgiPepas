...
<head>
<title>Editar retencion - Administraci�n MinappES</title>
<style type="text/css">
...
$(function() {
	...
	$( '#rfecha' ).datepicker( 'setDate', '<?php echo $rete_desde_fec; ?>' );
...
<h1>Editar retencion</h1>

<b>Datos de la retencion:</b><br>

<br>

<form action="mant_retenciones_edit_p.php" method="post" enctype="multipart/form-data">
<table>
...
<tr><td align="right">Tasa (en %):</td><td><input type="text" id="tas" name="tas" maxlength="7" size="16" value="<?php echo $rete_tasa; ?>" /></td></tr>
<tr><td align="right">Monto minimo:</td><td><input type="text" id="min" name="min" maxlength="10" size="16" value="<?php echo $rete_min_monto; ?>" /></td></tr>
