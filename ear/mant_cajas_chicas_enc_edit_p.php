...
$stmt = $mysqli->prepare("UPDATE cajas_chicas_enc SET cch_id=?, usu_id=?, cce_act=? WHERE cce_id=?") or die ($mysqli->error);
...
$desc = "Editar encargado caja chica ($id), caja $cch ($cch_id), usuario $usu ($usu_id), activo $act ($cce_act), hecha por ".$_SESSION['rec_usu_nombre'];
