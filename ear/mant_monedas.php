...
<head>
<title>Mantenedor Monedas - Administraci�n MinappES</title>
<style type="text/css">
...
function editar(anio, mes) {
	location.href="mant_monedas_edit.php?anio="+anio+"&mes="+mes;
}

function borrar(anio, mes, aniomes) {
	var valor=confirm('Est\u00e1 seguro que desea eliminar el dia tope dia del '+aniomes+'?');

	if(valor==true) { location.href="mant_monedas_del_p.php?anio="+anio+"&mes="+mes; }
}
</script>
<style>
.iconos {
