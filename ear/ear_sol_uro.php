...
if (getHabilitadoRegistrarEAR($slave_usu_id) == 0) {
	echo "<font color='red'><b>ERROR: No puede registrar m&aacute;s solicitudes, el colaborador seleccionado se ha excedido el m&aacute;ximo de EAR desembolsados sin liquidar.</b></font><br>";
	exit;
}
...
$(document).ready(function()
{
	...
	$('#hosp_body').on('change', '.hosp_ciud', function(){
		if (hosp_otros_id != $('option:selected', this).val()) {
			...
			$(this).parent().parent().children('.precio_td').children('.precio').show();
			$(this).parent().parent().children('.precio_td').children('.precio_i_span').hide();

			var precio = $('option:selected', this).attr('monto');
			$(this).parent().parent().children('.precio_td').children('.precio').html(precio);
		}
		else {
...
<h1>Registrar Solicitud de Vi�ticos y/o Entregas a Rendir (EAR) <?php echo getNomZona($zona_id); ?></h1>

<p><span style="font-weight:bold; background-color:yellow;">NOTA: Est� registrando la solicitud a nombre de otro colaborador</span></p>

<form id="solicitud" action="ear_sol_uro_p.php" method="post">
...
<tr>
	...
	<td><span id="alim_montodia"><?php echo getViaticosMonto('02', $mon_id, $zona_id); ?></span></td>
...
<tr>
	...
	<td><span id="movi_montodia"><?php echo getViaticosMonto('04', $mon_id, $zona_id); ?></span></td>
...
<tr>
	<td rowspan="2">Gastos de Representaci�n</td>
	<td class="encabezado_h"></td>
	<td class="encabezado_h"></td>
	<td class="encabezado_h">Monto</td>
	<td class="encabezado_h">Subtotal</td>
...
<tr>
	...
	<td class="encabezado_h">Item / Descripci�n</td>
	<td class="encabezado_h"></td>
	<td class="encabezado_h">Monto</td>
	<td class="encabezado_h">Subtotal</td>
	<td class="encabezado_h">Borrar</td>
