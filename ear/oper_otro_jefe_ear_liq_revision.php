...
<h1>Revisar Liquidaci�n EAR <?php echo $zona_nom; ?></h1>
...
<form id="liquidacion" action="oper_otro_jefe_ear_liq_revision_p.php" method="post">
...
<?php if(!is_null($pla_id)) echo getFilaPlanillaMovilidad($pla_id, $mon_id, 2); else echo getFilaVaciaPlaMov(2); ?>
...
<input type="hidden" value="<?php echo $otro_jefe_usu_id; ?>" name="otro_jefe_usu_id">
...
<b>Aprobar</b> transmite la liquidaci�n a administraci�n (Ya no podr� hacer m�s modificaciones). </p>
