...
$stmt = $mysqli->prepare("DELETE FROM vehiculos WHERE veh_id=?") or die ($mysqli->error);
$stmt->bind_param('i',
	$id);
$stmt->execute() or die ($mysqli->error);

$stmt = $mysqli->prepare("INSERT INTO movimientos VALUES (null, ?, ?, ?, ?, ?)") or die ($mysqli->error);
$desc = "Eliminar vehiculo ($id), placa $veh_placa, marca $vm_nombre, modelo $veh_modelo, usuario $usu_nombre, hecha por ".$_SESSION['rec_usu_nombre'];
