...
$stmt = $mysqli->prepare("UPDATE gastos_colobjects SET gti_id=?, gco_nom=?, gco_cobj=?, gco_act=? WHERE gco_id=?") or die ($mysqli->error);
...
$desc = "Editar colobject ($id), tipo $gti (ant $gti_id), nombre $nom (ant $gco_nom), cobj $gco (ant $gco_cobj), hecha por ".$_SESSION['rec_usu_nombre'];
