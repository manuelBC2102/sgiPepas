...
<head>
<title>Mantenedor Detracciones - Administraci�n MinappES</title>
<style type="text/css">
...
<script>
function editar(id) {
	location.href="mant_detracciones_edit.php?id="+id;
}

function borrar(id, desc, cod) {
	var valor=confirm('Est\u00e1 seguro que desea eliminar la detraccion '+desc+' ('+cod+')?');

	if(valor==true) { location.href="mant_detracciones_del_p.php?id="+id; }
}
</script>
<style>
.iconos {
...
<h1>Mantenedor Detracciones <a href="mant_detracciones_new.php"><img src="img/new_icon24.png" border="0" title="Registrar nueva detraccion"></a></h1>
