...
$ear_numero = "LGS_".str_replace("/", "_", $ear_numero)."_AJU";
...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue(++$columna.'3', 'MontoAsumidoMinapp');

// Miscellaneous glyphs, UTF-8
$i=4;
foreach ($arrLiqDet as $k => $v) {
	// [21]:1 = Aprobado
	if ($v[21]==1 && round($v[12]+$v[13]-$v[22])>0) {
		$pzas = explode("-", $v[6]);
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Ajustes');
