...
<head>
<!--<title>EAR Actualizar Liquidaciones con Reembolsos pendientes - Administraci�n - Minapp</title>-->
...
$(document).ready(function()
{
	$('.ear_liq_act').click(function(){
		...
		location.href="ear_liq_act_tesocomp_p.php?id="+ear_id+"&oper=1";
	});
});
</script>
...
<h1>Actualizaci&oacute;n de liquidaciones con reembolsos pendientes</h1>
...
foreach ($arrListSol as $v) {
	if ($v[15]<0) {
		...
		echo "<span class='ear_liq_act' fila='".$v[0]."' style='cursor: pointer'><img src='img/money-bag-dollar.png' border='0' title='Actualizar' class='iconos'></span>\n";
		echo "</td>\n";
